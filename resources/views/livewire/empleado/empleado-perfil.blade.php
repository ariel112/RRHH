                                                                            ...
                                                                            <div class="profile-info-left">
                                                                                ...
                                                                                <div id="divBtnestado">
                                                                                    @if ($cargo->tipo_empleado_id == 1)
                                                                                        @if ($empleado->estatus_id == 1)
                                                                                            <button type="button" if class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="right" title="Condición de empleado: MARCA ASISTENCIA">ACTIVO</button>
                                                                                        @else
                                                                                            <button type="button" if class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Condición de empleado: MARCA ASISTENCIA">INACTIVO</button>
                                                                                        @endif
                                                                                    @else
                                                                                        @if ($empleado->estatus_id == 1)
                                                                                            <button type="button" if class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="right" title="Condición de empleado: NO MARCA ASISTENCIA">
                                                                                                ACTIVO
                                                                                            </button>
                                                                                        @else
                                                                                            <button type="button" if class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Condición de empleado: NO MARCA ASISTENCIA">
                                                                                                INACTIVO
                                                                                            </button>
                                                                                        @endif
                                                                                    @endif
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="card shadow p-3 mb-5 bg-white rounded">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <label class="col-form-label">Banco<span class="text-danger">*</span></label>
                                                                                    <select class="form-select form-control" required id="cargo_bancos" name="cargo_bancos">
                                                                                        <option selected value="{{$empleado->bancos_id}}">{{$banco->nombre}}</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
        ...
        function cargo_bancos(){
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            document.getElementById('cargo_bancos').innerHTML += '<option value="'+data[i].id+'" ">'+data[i].nombre+'</option>';
                            }
                        },
                        error: function (jqXHR, textStatus, errorThrown) {
                            console.log(jqXHR, textStatus, errorThrown);
