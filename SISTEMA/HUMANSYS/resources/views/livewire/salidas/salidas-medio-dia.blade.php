        ...
        <div class="m-2">
            ...
            <form action="" class=" d-flex align-items-end">
                ...
                <div class=" ">
                    ...
                    <div class="col-sm-10">
                        <input id="fechaMedioDia" type="date" class="form-control" id="fechaDiaSalida " style="width:200px">
                    </div>
                </div>
        ...
        var table = $('#tablaEmpleadosSalidas').DataTable({
            ...
            buttons: [{
                ...
                action: function() {
                    ...
                    let fecha = document.getElementById('fechaMedioDia').value;
                    //console.log(fecha);

                    let entrada = document.getElementById('entradaCheck').checked
                    //console.log(fecha, tanda);

                    let salida = document.getElementById('salidaCheck').checked
                    //console.log(fecha, tanda);
                    ...
                    if (!(entrada || salida)) {
                        Swal.fire({
                            title: "Error!",
                            text: "Seleccione si el registro es de tipo entrada ó salida.",
                            icon: "error",
                            confirmButtonText: "Cerrar",
                        });
                        return;
