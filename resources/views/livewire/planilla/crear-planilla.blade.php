    ...
    <div class="content container-fluid">
        ...
        <div class="content container-fluid">
            <div class=" animate__animated animate__fadeInUpBig" style="margin:auto; opacity:80%;">
                <div class="card shadow p-3 mb-5 bg-white rounded border border-info" style="opacity:90%;">
                        ...
                        <form>
                            <div>
                                <div class="form-group row">
                                    <label for="namePlanilla" class="col-sm-2 col-form-label">Número-memo</label>
                                    <div class="col-sm-10">
