...
class EmpleadoPerfil extends Component
{
    ...
    public function render(Request $request)
    {
       ...
       /* foreach ($deducciones_emps as $deduc) {
        ...
        $emp_banco = DB::SELECTONE("select bancos_id from empleado where id=".$request['id'].';');
        $banco_empleado = DB::SELECTONE("select * from bancos where id=".$emp_banco->bancos_id.';');
