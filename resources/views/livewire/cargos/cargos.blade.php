                ...
                <div class="modal-body">
                    <form id="form_contrato" data-parsley-validate >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label class="col-form-label">Tipo de asistencia<span class="text-danger">*</span></label>
                                    <select required class="form-control" name="tipo_empleado" id="tipo_empleado">
                                        <option selected value="">Seleccione el tipo</option>
                                        <option value="1">CON TOMA DE ASISTENCIA</option>
                                        <option value="2">SIN TOMA DE ASISTENCIA</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-8">
