...
function panelControl(){
    ...
    .then((response) => {
               ...
               document.getElementById('aprobadosRRHH').innerHTML=response.data.aprobados.aprobados;
               document.getElementById('pendientesRRHH').innerHTML=response.data.pendientes.pendientes;
