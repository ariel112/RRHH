                ...
                <div class="modal-body">
                    <form id="form_contrato" data-parsley-validate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-group">
                                    <label class="col-form-label"> <b>Fecha de contrato</b>  <span class="text-danger">*</span></label>
                                    <div class="row">
                                        <div class="col-sm-6">
...
function cargo(data){
    ...
    /* data.forEach(element => html_select += '<option value="">'+element+'</option>'); */
    /* html_select += '<option value="'+element.id_gerente+'">'+element.nombre +'</option>' */
 }
...
function editar() {
        Swal.fire({
            title: 'Confirme la edicion de datos de contrato.',
            showDenyButton: true,
            ...
            // console.log('datos: ', $("#idPic").serialize());
                ...
                Swal.fire('No se ha realizado ningún cambio en éste contrato', '', 'info')
            }
        })
    }
